...
class Purchase extends CI_Controller
{
    ...
    public function getPurchaseRecord()
    {
        ...
        $purchases = $this->db->query("
            ...
            LEFT JOIN tbl_outlet br on br.branch_id = pm.branch_id
    ...
    public function  deletePurchase()
    {
        ...
        try {
            $data = json_decode($this->input->raw_input_stream);
            $purchase = $this->db->select('*')->where('PurchaseMaster_SlNo', $data->purchaseId)->get('tbl_purchase_master')->row();
            ...
            $returnCount = $this->db->query("select * from tbl_purchase_return pr where pr.PurchaseMaster_InvoiceNo = ? and pr.status = 'a'", $purchase->PurchaseMaster_InvoiceNo)->num_rows();
            if ($returnCount != 0) {
            ...
            $purchaseDetails = $this->db->select('Product_IDNo,PurchaseDetails_TotalQuantity,PurchaseDetails_TotalAmount')->where('PurchaseMaster_IDNo', $data->purchaseId)->get('tbl_purchase_details')->result();
            ...
            $this->db->set($purchase)->where('PurchaseMaster_IDNo', $data->purchaseId)->update('tbl_purchase_details');
            /*Delete Purchase Master Data*/
            $this->db->set($purchase)->where('PurchaseMaster_SlNo', $data->purchaseId)->update('tbl_purchase_master');
    ...
    public function addPurchaseReturn()
    {
        ...
        try {
            ...
            $this->db->insert('tbl_purchase_return', $purchaseReturn);
            ...
            foreach ($data->cart as $product) {
                ...
                $this->db->insert('tbl_purchase_return_details', $returnDetails);
    ...
    public function updatePurchaseReturn()
    {
        ...
        try {
            ...
            $oldReturn = $this->db->query("select * from tbl_purchase_return where PurchaseReturn_SlNo = ?", $purchaseReturnId)->row();
            ...
            $this->db->where('PurchaseReturn_SlNo', $purchaseReturnId)->update('tbl_purchase_return', $purchaseReturn);

            $oldDetails = $this->db->query("select * from tbl_purchase_return_details prd where prd.PurchaseReturn_SlNo = ?", $purchaseReturnId)->result();
            ...
            $this->db->query("delete from tbl_purchase_return_details where PurchaseReturn_SlNo = ?", $purchaseReturnId);
            $totalReturnAmount = 0;
            foreach ($data->cart as $product) {
                $returnDetails = array(
                    'PurchaseReturn_SlNo' => $purchaseReturnId,
    ...
    public function purchaseEdit($purchaseId)
    {
        ...
        $data['invoice'] = $this->db->query("select PurchaseMaster_InvoiceNo from tbl_purchase_master where PurchaseMaster_SlNo = ?", $purchaseId)->row()->PurchaseMaster_InvoiceNo;
        $data['content'] = $this->load->view('Administrator/purchase/purchase_order', $data, TRUE);
        $this->load->view('Administrator/index', $data);
    }
    ...
    function SelectPruduct()
    {
        ...
        $querys = $this->db->query("
            ...
            LEFT JOIN tbl_brand on tbl_brand.brand_SiNo=tbl_product.Brand_ID
    ...
    public function addPurchase()
    {
        ...
        try {
            ...
            $invoiceCount = $this->db->query("select * from tbl_purchase_master where PurchaseMaster_InvoiceNo = ?", $invoice)->num_rows();
            if ($invoiceCount != 0) {
                $invoice = $this->mt->generatePurchaseInvoice();
            }
            ...
            $this->db->insert('tbl_purchase_master', $purchase);
            ...
            foreach ($data->cartProducts as $product) {
                ...
                $this->db->insert('tbl_purchase_details', $purchaseDetails);
                $previousStock = $this->mt->productStock($product->productId);

                $inventoryCount = $this->db->query("select * from tbl_product_inventory where product_id = ? and branch_id = ?", [$product->productId, $this->session->userdata('BRANCHid')])->num_rows();
                if ($inventoryCount == 0) {
                    $inventory = array(
                    ...
                    $this->db->insert('tbl_product_inventory', $inventory);
                } else {
                    $this->db->query("
                        update tbl_product_inventory 
                        set purchase_quantity = purchase_quantity + ? 
    ...
    public function updatePurchase()
    {
        ...
        try {
            ...
            $this->db->update('tbl_purchase_master', $purchase);

            $oldPurchaseDetails = $this->db->query("select * from tbl_purchase_details where PurchaseMaster_IDNo = ?", $purchaseId)->result();
            $this->db->query("delete from tbl_purchase_details where PurchaseMaster_IDNo = ?", $purchaseId);
    ...
    function addDamage()
    {
        ...
        try {
            ...
            foreach ($data->carts as $key => $product) {
                ...
                $this->db->insert('tbl_damage_details', $damageDetails);

                $this->db->query("
                    update tbl_product_inventory ci 
    ...
    public function updateDamage()
    {
        ...
        try {
            ...
            $oldProduct = $this->db->query("select * from tbl_damage_details where Damage_SlNo = ?", $damageId)->result();
            ...
            $this->db->query("DELETE FROM `tbl_damage_details` WHERE  Damage_SlNo = ?", $damageId);
    ...
    public function deleteDamage()
    {
        ...
        try {
            ...
            foreach ($oldProduct as $key => $item) {
                ...
                $this->db->where('Damage_SlNo', $damageId)->update('tbl_damage_details', ['status' => 'd']);
            }
    ...
    public function getPurchaseReturns()
    {
        ...
        $returns = $this->db->query("
            ...
            join tbl_purchase_master pm on pm.PurchaseMaster_InvoiceNo = pr.PurchaseMaster_InvoiceNo
            LEFT JOIN tbl_supplier s on s.Supplier_SlNo = pr.Supplier_IDdNo
    ...
    public function deletePurchaseReturn()
    {
        ...
        try {
            ...
            $oldReturn = $this->db->query("select * from tbl_purchase_return where PurchaseReturn_SlNo = ?", $data->id)->row();

            $returnDetails = $this->db->query("select * from tbl_purchase_return_details where PurchaseReturn_SlNo = ?", $data->id)->result();
            ...
            $this->db->set($returnPurchase)->where('PurchaseReturn_SlNo', $data->id)->update('tbl_purchase_return_details');
            $this->db->set($returnPurchase)->where('PurchaseReturn_SlNo', $data->id)->update('tbl_purchase_return');
    ...
    public function checkPurchaseReturn($invoice)
    {
        ...
        $returnCount = $this->db->query("select * from tbl_purchase_return where PurchaseMaster_InvoiceNo = ? and status = 'a'", $invoice)->num_rows();
