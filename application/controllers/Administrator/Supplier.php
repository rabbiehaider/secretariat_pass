...
class Supplier extends CI_Controller
{
    ...
    function search_supplier_payments()
    {
        ...
        (select ifnull(sum(PurchaseMaster_SubTotalAmount), 0.00) from tbl_purchase_master where Supplier_SlNo = s.Supplier_SlNo and PurchaseMaster_OrderDate < '$Purchase_startdate' ) as purchaseAmount,
        ...
        (select ifnull(sum(PurchaseReturn_ReturnAmount), 0.00) from tbl_purchase_return where Supplier_IDdNo = s.Supplier_SlNo and PurchaseReturn_ReturnDate < '$Purchase_startdate') as returnAmount,
