...
class TrashData extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['sales'] = $this->db->query("select * from tbl_sale_master where status = 'd' and branch_id = ?", $this->brunchId)->result();
        $data['purchases'] = $this->db->query("select * from tbl_purchase_master where status = 'd' and branch_id = ?", $this->brunchId)->result();
        ...
        $data['cashtransactions'] = $this->db->query("select * from tbl_cash_transactions where status = 'd' and branch_id = ?", $this->brunchId)->result();
