...
class loginVerify extends CI_Controller {
    ...
    public function Verify_Code_check(){
        ...
        $x = "SELECT tbl_user.*,tbl_outlet.* from tbl_user left join tbl_outlet on tbl_outlet.branch_id = tbl_user.userBranch_id where  tbl_user.verifycode ='$pass' AND tbl_user.User_Name='$User_Name'";
        $sql = mysql_query($x);
