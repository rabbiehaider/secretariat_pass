...
<div id="sales" class="row">
	...
	<div class="col-xs-12 col-md-9">
		<div class="row">
					...
					<div class="control-group">
						<div class="form-group clearfix" style="margin-bottom: 3px;">
							...
							<div class="col-xs-8">
								...
								<input type="radio" name="salesType" value="online" v-model="sales.salesType" v-on:change="onSalesTypeChange"> Online
							</div>
						</div>
						<div class="form-group">
			...
			<div class="col-xs-12 col-md-1 no-padding" style="height: 164px;background: #65c1c1;border: 1px solid gray;margin-top: 10px;border-radius: 5px;">
		...
		methods: {
			...
			addToCart() {
				let product = {
					...
					categoryName: this.selectedProduct.Category_Name,
			...
			async getSales() {
				await axios.post('/get_sales', {
					...
					this.sales.customerId = sales.Customer_IDNo;
					...
					this.oldCustomerId = sales.Customer_IDNo;
					...
					this.selectedCustomer = {
						Customer_SlNo: sales.Customer_IDNo == null ? '' : sales.Customer_IDNo,
