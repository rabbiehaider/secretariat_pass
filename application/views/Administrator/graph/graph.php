<style>
    ...
    .custom-table-bordered>thead>tr>th {
        border: 1px solid #1b5757;
    }

    .overAllData {
        height: 290px;
        border: 2px solid #128282;
    }
    ...
    <div class="row overAllData">
        <div v-if="showOverallData" style="display:none;" v-bind:style="{ display: showOverallData ? '' : 'none' }">
            <div class="col-md-12 no-padding">
                <marquee scrollamount="3" onmouseover="this.stop();" onmouseout="this.start();" direction="left" height="30" bgcolor="#1b5757" style="color:white;padding-top:5px;margin-bottom: 15px;">{{ salesText }}</marquee>
            </div>
    ...
    <div class="row graphData">
        <div v-if="showGraphData" style="display:none;" v-bind:style="{ display: showGraphData ? '' : 'none' }">
            <div class="col-md-12 col-xs-12 no-padding">
                <div style="background: #1b5757;width:100%;height:30px;display: flex;align-items: center;gap: 5px;">
        ...
        <div v-if="showTopData" style="display:none;" v-bind:style="{ display: showTopData ? '' : 'none' }">
            ...
            <div class="col-md-4 col-xs-12 col-md-offset-2">
                <table class="table custom-table-bordered" style="margin: 0;margin-top:20px;">
                    <thead>
                        <tr>
                            <td class="text-center" colspan="2" style="background-color: #1b5757;color: white;font-weight: 900;">Top Customers</td>
                        </tr>
                    </thead>
                    <tbody>
