		...
		<fieldset class="scheduler-border scheduler-search">
			...
			<div class="control-group">
				<div class="form-group">
					...
					<div class="col-xs-3">
						<v-select v-bind:options="invoices" label="invoice_text" v-model="selectedInvoice" v-bind:disabled="purchaseReturn.returnId == 0 ? false : true" placeholder="Select Invoice No" @search="onSearchInvoice"></v-select>
					</div>
					<div class="col-xs-2">
