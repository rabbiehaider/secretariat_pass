							...
							<div class="row">
								<div class="col-xs-12 col-sm-3 center">
									<span class="profile-picture">
										<img class="editable img-responsive" style="width: 260px;height: 260px;" alt="<?php echo $this->session->userdata('FullName'); ?>" id="profileImage" :src="imageUrl" />
									</span>
								...
								<div class="col-xs-12 col-sm-9">
									...
									<div class="profile-user-info">
										...
										<div class="profile-info-row">
											<div class="profile-info-name"> Outlet Name </div>
										...
										<div class="profile-info-row">
											<div class="profile-info-name">Outlet Location </div>
									...
									<div class="hr hr-8 dotted" style="margin: 5px 0;"></div>
									<div class="profile-user-info">
										<div class="profile-info-row">
