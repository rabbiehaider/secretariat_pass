        ...
        <div class="col-md-3">
            ...
            <div class="group">
                ...
                <ul ref="admin">
                    ...
                    <li><input type="checkbox" class="access" value="color" v-model="access"> Color Entry</li>
                    <li><input type="checkbox" class="access" value="unit" v-model="access"> Unit Entry</li>
                    <li><input type="checkbox" class="access" value="district" v-model="access"> District Entry</li>
                    <li><input type="checkbox" class="access" value="thana" v-model="access"> Thana Entry</li>
