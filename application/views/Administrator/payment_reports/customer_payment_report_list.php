        ...
        <tr>
            ...
            <!-- Page Body -->
              ...
              foreach($record as $record){ 
                ...
                // }
                 $sl++;
                $this->db->select('tbl_sale_master.*')->select_sum('tbl_sale_details.Discount_amount ', 'pro_dis')->from('tbl_sale_master');
                $this->db->join('tbl_sale_details', 'tbl_sale_master.SaleMaster_SlNo = tbl_sale_details.SaleMaster_IDNo', 'left');
                $SaleM = $this->db->where('tbl_sale_master.SaleMaster_InvoiceNo',$record->CPayment_invoice)->get()->row();
