...
$route['category']        = 'Administrator/Page/category';
$route['get_categories']  = 'Administrator/Page/getCategories';
$route['add_category']    = 'Administrator/Page/addCategory';
$route['update_category'] = 'Administrator/Page/updateCategory';
$route['delete_category'] = 'Administrator/page/deleteCategory';

$route['sub_category']        = 'Administrator/Page/subCategory';
$route['get_sub_categories']  = 'Administrator/Page/getSubCategories';
$route['add_sub_category']    = 'Administrator/Page/addSubCategory';
$route['update_sub_category'] = 'Administrator/Page/updateSubCategory';
...
$route['add_color']    = 'Administrator/Page/insert_color';
$route['update_color'] = 'Administrator/Page/colorupdate';
$route['delete_color'] = 'Administrator/Page/colordelete';
$route['get_colors']   = 'Administrator/Page/getColors';

$route['district']        = 'Administrator/Page/district';
$route['add_district']    = 'Administrator/Page/insert_district';
$route['delete_district'] = 'Administrator/Page/districtdelete';
$route['update_district'] = 'Administrator/Page/districtupdate';
$route['get_districts']   = 'Administrator/Page/getDistricts';

$route['thana']        = 'Administrator/Page/thana';
$route['add_thana']    = 'Administrator/Page/insert_thana';
$route['delete_thana'] = 'Administrator/Page/thanadelete';
$route['update_thana'] = 'Administrator/Page/thanaupdate';
$route['get_thanas']   = 'Administrator/Page/getThanas';
...
$route['deleted_cpayment']        = 'Administrator/TrashData/deletedCustomerPayment';
$route['deleted_spayment']        = 'Administrator/TrashData/deletedSupplierPayment';
...
$route['deleted_sinvoice/(:any)'] = 'Administrator/TrashData/deletedSaleInvoice/$1';
$route['deleted_pinvoice/(:any)'] = 'Administrator/TrashData/deletedPurchaseInvoice/$1';
...
$route['barcode/(:any)']             = 'Administrator/Products/barcodeGenerate/$1';
$route['reorder_list']               = 'Administrator/Reports/reOrderList';

$route['get_product_images']    = 'Administrator/Products/getProductImages';
$route['check_gallery_image']   = 'Administrator/Products/checkGalleryImage';
$route['delete_pgallery_image'] = 'Administrator/Products/deletePGalleryImage';
...
// Website Content
$route['websiteProfile']         = 'Administrator/Website/websiteContent';
$route['get_website_profile']    = 'Administrator/Website/getWebsiteProfile';
$route['update_website_profile'] = 'Administrator/Website/updateWebsiteProfile';

$route['page_content']           = 'Administrator/Website/webPageContent';
$route['get_website_profile']    = 'Administrator/Website/getWebsiteProfile';
$route['update_website_profile'] = 'Administrator/Website/updateWebsiteProfile';
