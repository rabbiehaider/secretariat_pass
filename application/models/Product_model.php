...
class Product_model extends CI_Model
{
	...
	public function products_by_brunch(){
		...
		$res = $this->db
                            ->join('tbl_brand','tbl_brand.brand_SiNo=tbl_product.Brand_ID','left')
	...
	public function get_all_product_price_list(){
		...
		$this->db->join('tbl_brand', 'tbl_brand.brand_SiNo=tbl_product.Brand_ID');
	...
	public function get_all_product_price_category_wise($cat_id = Null){
		$this->db->select(' tbl_product.*, tbl_category.*,tbl_brand.*')->from('tbl_product');
	...
	{	
		...
		$this->db->select('tbl_damage.*,tbl_damage_details.*,tbl_product.*, tbl_unit.*')->from('tbl_damage');
		$this->db->join('tbl_damage_details', 'tbl_damage_details.Damage_SlNo = tbl_damage.Damage_SlNo', 'left');
		$this->db->join('tbl_product', 'tbl_product.Product_SlNo= tbl_damage_details.Product_SlNo', 'left');
	...
	{	
		...
		$this->db->join('tbl_product', 'tbl_product.Product_SlNo= tbl_damage_details.Product_SlNo', 'left');
		$this->db->join('tbl_unit', 'tbl_unit.Unit_SlNo = tbl_product.Unit_ID', 'left');
		$this->db->where('tbl_damage_details.Product_SlNo',$pro_id);
		$this->db->where('tbl_damage.branch_id',$this->BRANCHid);
		$this->db->where('tbl_damage.status','a');
		$res = $this->db->order_by('tbl_damage.Damage_InvoiceNo', 'desc')->get()->result();
