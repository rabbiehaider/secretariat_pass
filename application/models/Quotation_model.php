...
class Quotation_model extends CI_Model
{
	...
	public function find_quotation_info_by_id($quotation_id  = Null){
		...
		$this->db->join('tbl_quotaion_customer', 'tbl_quotaion_customer.quotation_customer_id = tbl_quotation_master.Customer_IDNo', 'left');
	...
	public function get_invoice_wise_quotation_product_details($quotation_id = Null){
		...
		$this->db->select('tbl_quotation_details.*, tbl_product.*,tbl_category.*,tbl_color.*,tbl_brand.*')->from('tbl_quotation_details');
